  ...
  return (
    <div>
        ...
        isGameWon && (
          <div className="flex flex-row bg-modal w-screen h-screen z-10 fixed top-0 left-0 justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-5">
              ...
              <img className="max-w-[250px] max-h-[150px]" src="/image/chicken.gif" alt="" />
        ...
        isGameOver && (
          <div className="flex flex-row bg-modal w-screen h-screen z-10 fixed top-0 left-0 justify-center items-center">
            <div className="flex flex-col justify-center items-center gap-5">
              ...
              <img className="max-w-[250px] max-h-[150px]" src="/image/strider.gif" alt="" />
              <p>Your final score is {score}</p>
              <div className="flex flex-col gap-2">
                <button onClick={handlePlayAgain}  className="activeButton">Play Again</button>
                <button onClick={handleQuit} className="activeButton">Quit</button>
      ...
      <div className="flex flex-col justify-center items-center " >
        <img src="/image/logo.png" alt="logo" className="w-[300px] h-[100px] mt-[10px]" onClick={handleQuit}/>
